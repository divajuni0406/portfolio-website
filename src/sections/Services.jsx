...
const Services = () => {
  ...
  return (
    <section className="p-sectionPadding" id="services">
      ...
      >
        ...
        >
          {servicesList.map(
            ({ title, ServicesIcon, description, services }, index) => (
              <motion.div
                ...
                className={`${
                  theme === "light"
                    ...
                    : "bg-altSecondary text-white hover:border-altPrimary"
