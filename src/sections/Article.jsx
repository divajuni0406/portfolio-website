...
const Article = () => {
  ...
  return (
    <section className="p-sectionPadding" id="article">
      ...
      >
        ...
        <SectionDescription>
          There are some article about programming that i create to add more
          insight and also to share knowledge
        </SectionDescription>
        ...
        >
          {articleList.map(
            ({ title, img, uploadedAt, tags, description }, index) => (
              <motion.div
                ...
                } shadow-cardShadow hover:shadow-xl flex flex-col gap-y-4 rounded-md p-5 transition-all duration-300 group`}
              >
                  ...
                  <div className="absolute top-[-100%] group-hover:top-2 left-2 transition-all duration-300">
                    {tags.map((tag, index) => (
                      <div
                        ...
                        } text-white font-medium text-[0.8em] px-2 py-1 rounded-md`}
                      >
                        {tag}
                      </div>
                    ))}
                ...
                <div className="flex flex-col gap-y-3">
                  <h4
                    ...
                    } font-semibold text-[1em] cursor-pointer transition-all duration-300`}
                  >
                    {title}
                  </h4>
