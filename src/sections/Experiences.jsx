  ...
  useEffect(() => {
    const observer = new IntersectionObserver((entries) => {
      ...
      if (entry.isIntersecting) {
        setActiveDots("experiences");
        return;
      }
    });
    observer.observe(experiences.current);
  }, [setActiveDots]);

  return (
    <section className="p-sectionPadding" id="experiences">
      ...
      >
        ...
        >
                ...
                <div
                  className={`${
                    theme === "light"
                      ...
                      : "bg-altSecondary/30 text-altPrimary"
                  } p-5 shadow-md w-fit rounded-full transition-all duration-300 group-hover:-translate-y-2`}
                >
                  <SkillIcon className="text-[2rem]" />
                </div>
                <div className="flex flex-col gap-y-2 text-center">
                  <h3 className="font-semibold lg:text-[1em] text-[0.9em]">
                    {title}
                  </h3>
                  <h4
                    className={`${
          ...
          >
            <SectionSubtitle className="lg:text-end text-end">
              Skills & Tech Stack
            </SectionSubtitle>
            <motion.p
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center order-1 lg:text-start text-center">
            ...
            >
              Here are some formal educations and certificates that I&apos;ve
              achieved:
            </motion.p>
          </div>

          {/* Educations & Certificates Content */}
          <div
            className={`${
              theme === "light"
                ? "bg-white text-black"
          ...
          >
            ...
            <div className="flex flex-col gap-y-6">
              <motion.h3
                ...
                } font-medium text-white px-3 py-1 w-fit rounded-md flex items-center gap-x-2 transition-all duration-300 hover:-translate-y-2`}
              >
