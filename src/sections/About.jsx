...
const About = () => {
  ...
  return (
    <section className="h-full w-screen p-sectionPadding" id="about">
      {/* About Section Title */}
      ...
      >
        ...
        <motion.div
          ...
          className={`${
            theme === "light" ? "bg-primaryGradient" : "bg-altPrimaryGradient"
          } lg:w-full w-fit lg:mx-0 mx-auto lg:aspect-square rounded-[1rem] grid place-items-center`}
        >
          <div className="lg:h-[40rem] md:h-[33rem] h-[22.5rem] overflow-hidden lg:rotate-[10deg] rotate-6 rounded-[1rem] transition-all duration-300 hover:rotate-0">
            <img
              src={picture[1]}
              alt={"About Banner"}
        ...
        >
          ...
          <motion.div
            ...
            className={`${
              theme === "light"
                ? "border-[#777777]/50 text-black"
                : "border-altLight/50 text-white"
            } lg:border-b-[2px] mb-8 lg:text-start text-center lg:mt-0 mt-6`}
          >
            <motion.h2
            ...
            <motion.p
              ...
              className={`${
                theme === "light" ? "text-[#777777]" : "text-altLight"
              } max-w-[85%] w-full text-base md:text-lg pb-6 font-normal lg:mx-0 mx-auto`}
            >
              {description[1]}
            </motion.p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:place-self-start place-self-center gap-6 mb-10 w-[80%]">
            {aboutExperiencesList.map(({ number, title }, index) => (
              ...
              >
                <h3
                  className={`${
                    theme === "light" ? "text-primary" : "text-altPrimary"
                  } text-[2.5em] font-bold group-hover:-translate-y-2 transition-all duration-200`}
                >
                  {number}
                </h3>
                <span
                  ...
                  } text-[0.9em] font-medium max-w-[10px]`}
                >
                  {title}
                </span>
              </motion.div>
