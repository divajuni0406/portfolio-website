...
export default function Modal({
  ...
  if (isOpen) {
    return (
      <div
        className="z-[100] fixed over flex justify-center items-center w-screen h-screen top-0 left-0 bg-[rgba(0,0,0,0.1)] backdrop-blur-[20px] transition-all duration-300"
        {...props}
      >
        <div
          className={`${
            isOpen ? "animate-fromTopAnimation" : "animate-toTopAnimation"
          } ${
            theme === "light"
              ? "bg-white text-black"
